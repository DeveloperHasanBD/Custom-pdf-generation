...
class PDF extends \TCPDF
{
    ...
    function __construct($orientation = 'P', $unit = 'mm', $format = 'A3', $unicode = true, $encoding = 'UTF-8', $diskcache = false, $pdfa = false)
    {
        ...
        $this->SetFont('montserratmedium', '', 11, '', true);
        $this->SetFont('montserrat', '', 11, '', true);
